...
useWebPageSchema({
  name: "Site Guide | Admin | Papa Everett's Pizza Co.",
  description: 'Admin guide.',
})

const { isAuthenticated: loggedIn, user, fetchUser } = useAuth()
...
const pages = [
  {
    name: 'Home',
    path: '/',
    desc: 'Landing page with hero, hours, featured menu items, photos, reviews, and your story.',
  },
  {
    name: 'Menu',
    path: '/menu',
    desc: 'Full interactive menu with live prices by category. Includes the Pizza Builder.',
  },
  ...
  { name: 'Catering', path: '/catering', desc: 'Catering services for events of all sizes.' },
  {
    name: 'Fundraisers',
    path: '/fundraisers',
    desc: 'Fundraiser programs for local organizations.',
  },
...
<template>
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex items-center gap-3 mb-6">
      <UButton to="/admin" variant="ghost" size="sm" icon="i-lucide-arrow-left"
    ...
    <div v-if="!loggedIn" class="mt-8 warm-card p-6">
      <p class="warm-muted">
        Please <ULink to="/admin" class="text-primary-600 underline">log in</ULink> to view the site
        guide.
      </p>
    </div>
    ...
    <template v-else>
      ...
      <div class="mt-8 grid lg:grid-cols-[220px_1fr] gap-8">
        ...
        <!-- Mobile nav -->
        <div
          class="lg:hidden sticky top-16 z-10 warm-surface/90 backdrop-blur-sm -mx-4 px-4 py-3 border-b border-pizza-border"
        >
        ...
        <div class="space-y-12 min-w-0">
          ...
          <article id="overview" class="scroll-mt-24" @click="activeSection = 'overview'">
            ...
            <div class="mt-4 text-pizza-muted leading-relaxed space-y-3">
              <p>
                This website was custom-built for Papa Everett's Pizza Co. It's a modern, fast,
                mobile-friendly site designed to showcase your menu, photos, and restaurant
                information to customers in Clear Lake and beyond.
              </p>
              <p>
                The site is optimized for Google search results and loads instantly on any device —
          ...
          <article id="pages" class="scroll-mt-24" @click="activeSection = 'pages'">
            ...
            <p class="mt-2 text-pizza-muted">
              Here are all the pages on your website. Click any to view it.
            </p>
            ...
            <div class="mt-4 grid sm:grid-cols-2 gap-3">
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  <div>
                    <p
                      class="font-semibold text-pizza-text group-hover:text-primary-700 transition-colors"
                    >
                      {{ page.name }}
                    </p>
                  ...
                  <UIcon
                    ...
                    class="size-4 text-pizza-muted shrink-0 mt-1"
                  />
                </div>
              </ULink>
            </div>
          ...
          <article
            id="menu-management"
            class="scroll-mt-24"
            @click="activeSection = 'menu-management'"
          >
            <h2 class="text-2xl font-bold tracking-tight flex items-center gap-2 text-pizza-text">
            ...
            <p class="mt-2 text-pizza-muted">
              The Admin Panel gives you full control over your menu, categories, and prices. Here is
              exactly how to use it.
            </p>

            <!-- Managing Categories -->
            <div class="mt-8">
              <h3 class="text-lg font-bold text-pizza-text border-b border-pizza-border pb-2 mb-3">
              ...
              <ul class="text-sm text-pizza-muted space-y-2 list-disc pl-5">
                <li>
                  Click the <strong>⚙ gear icon</strong> next to "Categories" to open the manager.
                </li>
                <li><strong>Add:</strong> Type a new name and click "Add".</li>
                <li>
                  <strong>Rename:</strong> Click the pencil icon, type the new name, and click the
                  checkmark or press Enter.
                  <em>This safely updates the category for all items inside it!</em>
                </li>
                <li>
                  <strong>Delete:</strong> Click the trash icon. You can only delete a category if
            ...
            <div class="mt-8">
              ...
              <ul class="text-sm text-pizza-muted space-y-2 list-disc pl-5">
                <li>
                  <strong>Basic Info:</strong> Change the Name, Category, Sort Order, or Description
                  directly in the text boxes.
                </li>
                <li>
                  <strong>Active Toggle:</strong> Switch an item to "Inactive" to hide it from the
                  public menu without deleting it.
                </li>
                <li>
                  <strong>Saving:</strong> Click the red <strong>Save</strong> button in the top
                  right of the item card. Changes go live instantly.
                </li>
              </ul>
            </div>
            ...
            <div class="mt-8">
              <h3 class="text-lg font-bold text-pizza-text border-b border-pizza-border pb-2 mb-3">
                3. How Pricing Fields Work
              </h3>
              <p class="text-pizza-muted text-sm mb-3">
                Pizzas have multiple sizes, while pastas might just have one price. The pricing
                editor adapts to both.
              </p>
              <ul class="text-sm text-pizza-muted space-y-3 list-none pl-0">
                <li class="rounded-lg warm-surface border border-pizza-border p-3">
                  ...
                  To add a standard size (Le Petit, Small, Medium, Large, XL), use the
                  <strong>Standard Field</strong> dropdown at the bottom of the item, select the
                  size, and click <strong>Add</strong>.
                </li>
                <li class="rounded-lg warm-surface border border-pizza-border p-3">
                  <strong class="text-pizza-text block mb-1">Custom Fields</strong>
                  If you need a unique size (like "Party Tray"), type it into the
                  <strong>Custom Field</strong> box and click <strong>Add Custom</strong>. It
                  handles spacing and formatting automatically.
                </li>
                <li class="rounded-lg warm-surface border border-pizza-border p-3">
                  <strong class="text-pizza-text block mb-1">Removing Prices</strong>
                  Click the <strong>X</strong> icon next to any price field to remove that size
                  option completely.
                </li>
              </ul>
            </div>
            ...
            <div class="mt-8 rounded-xl bg-primary-50 border border-primary-200 p-4">
              ...
              <ul class="mt-2 text-sm text-primary-700 space-y-1.5 list-disc pl-5">
                <li>
                  Leave a price field <strong>completely blank</strong> to show "Call for Current
                  Price" on the live menu.
                </li>
                <li>
                  Use the <strong>"Sort Order"</strong> number to control the display order. Lower
                  numbers show up first (e.g., 1 before 10).
                </li>
                <li>
                  Scroll to the very bottom of the category page to find the
                  <strong>Add Menu Item</strong> section to create new food items!
                </li>
              </ul>
            </div>
          </article>
            ...
            <div class="mt-4 grid sm:grid-cols-2 gap-3">
              <div class="rounded-xl border border-pizza-border p-4">
                ...
                <p class="text-pizza-muted text-sm mt-1">
                  Loads in under 1 second from anywhere in the world.
                </p>
              </div>
              <div class="rounded-xl border border-pizza-border p-4">
                <p class="font-semibold text-pizza-text flex items-center gap-2">
                ...
                <p class="text-pizza-muted text-sm mt-1">
                  HTTPS encryption and DDoS protection built in.
                </p>
              </div>
              <div class="rounded-xl border border-pizza-border p-4">
                <p class="font-semibold text-pizza-text flex items-center gap-2">
              ...
              <div class="rounded-xl border border-pizza-border p-4">
                ...
                <p class="text-pizza-muted text-sm mt-1">
                  Live at <strong>papaeverettspizza.com</strong>
                </p>
              </div>
            </div>

            <p class="mt-4 text-pizza-muted text-sm leading-relaxed">
              Your website runs on <strong>Cloudflare Workers</strong>, one of the fastest hosting
              platforms available. Your menu data is stored in a
              <strong>Cloudflare D1 database</strong>, so menu updates are saved permanently and
              load instantly.
            </p>
          </article>
          ...
          <article id="seo" class="scroll-mt-24" @click="activeSection = 'seo'">
            ...
            <p class="mt-2 text-pizza-muted">
              Your site is fully optimized to rank well for searches like "pizza Clear Lake Iowa" or
              "Papa Everett's menu."
            </p>
            ...
            <div class="mt-5 space-y-3">
              <div class="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-pizza-muted">
                    Your site is registered and verified. Google is actively crawling and indexing
                    your pages. Sitemap submitted.
                  </p>
                </div>
              </div>
              <div class="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-pizza-muted">
                    Tracks visitors, page views, and traffic sources. Measurement ID: G-8WZ93XNKHX.
                  </p>
                </div>
              </div>
              <div class="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-pizza-muted">
                    Additional behavior analytics and session recording.
                  </p>
                </div>
              </div>
              <div class="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-pizza-muted">
                    Structured data tells Google your hours, address, phone, and menu — powers rich
                    search results.
                  </p>
                </div>
              </div>
              <div class="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-pizza-muted">
                    Every page has optimized titles, descriptions, and social sharing images.
                  </p>
                </div>
              </div>
            </div>
                ...
                :columns="[
                  {
                    accessorKey: 'label',
                    header: 'Property',
                    meta: { class: { td: 'w-40 font-medium text-pizza-text bg-elevated' } },
                  },
                  {
                    accessorKey: 'value',
                    header: 'Value',
                    meta: { class: { td: 'text-pizza-muted' } },
                  },
                ]"
                :data="[
                  ...
                  {
                    label: 'Analytics',
                    value: 'PostHog + Google Analytics 4 + Google Search Console',
                  },
          ...
          <article id="support" class="scroll-mt-24" @click="activeSection = 'support'">
            ...
            <div class="mt-4 grid sm:grid-cols-2 gap-4">
              <div class="rounded-xl border border-primary-200 bg-primary-50 p-4">
                ...
                <ul class="mt-3 text-sm text-primary-700 space-y-2">
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-circle-check" class="size-4 shrink-0" /> Update menu item
                    prices
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-circle-check" class="size-4 shrink-0" /> Add new menu
                    items
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-circle-check" class="size-4 shrink-0" /> Deactivate old
                    items
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-circle-check" class="size-4 shrink-0" /> Change item names
                    or descriptions
                  </li>
                </ul>
              </div>
              ...
              <div class="rounded-xl border border-pizza-border warm-surface p-4">
                ...
                <ul class="mt-3 text-sm text-pizza-muted space-y-2">
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-wrench" class="size-4 shrink-0 o-50" /> Updating business
                    hours
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-wrench" class="size-4 shrink-0 o-50" /> Adding or
                    replacing photos
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-wrench" class="size-4 shrink-0 o-50" /> Creating new pages
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-wrench" class="size-4 shrink-0 o-50" /> Changing the site
                    design
                  </li>
                  <li class="flex items-center gap-2">
                    <UIcon name="i-lucide-wrench" class="size-4 shrink-0 o-50" /> Domain or hosting
                    changes
                  </li>
                </ul>
              </div>
            ...
            <div class="mt-5 rounded-xl border border-primary-200 bg-primary-50 p-5">
              ...
              <div class="mt-3 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
                ...
                <ULink
                  to="mailto:narduk@mac.com"
                  class="text-sm text-primary-700 hover:text-primary-900 flex items-center gap-1.5 transition-colors"
                >
